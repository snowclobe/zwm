...
BIN = zovwm
SRC = src/main.c src/client.c src/layout.c src/events.c src/keys.c src/bar.c src/keyconf.c src/wizard.c src/appconf.c src/tray.c src/powermenu.c src/monitorconf.c src/monitorwizard.c src/kblayout.c src/autostart.c src/kbwizard.c
OBJ = $(SRC:.c=.o)
